...
async def play_game(thread: disnake.Thread, member: disnake.Member, bot: disnake.ext.commands.Bot, uid: str, optional: str | None = None):
    ...
    undertale_trivia_questions_and_answers = {
        ...
        "What's the name of the monster that sells you ice cream?": ["Nice Cream Guy", "Ice Cap", "Gyftrot", "Snowdrake", "Undyne"],
        ...
        "What secret boss appears in the unused classroom?": ["Jevil", "Gaster", "Seam", "Chaos King", "Spamton NEO", "Spamton EX"],
        ...
        "What is the largest bone in the human body?": ["Femur", "Humerus", "Tibia", "Skull"],
        "What is the smallest planet in the solar system?": ["Mercury", "Mars", "Venus", "Pluto"],
        "What is the largest organ in the human body?": ["Skin", "Liver", "Lung", "Heart"],
        "What is the name of the game engine that OneShot was made with?": ["RPG Maker 2003", "RPG Maker XP",
                                                                            "RPG Maker VX Ace", "RPG Maker MV"],
